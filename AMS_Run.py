...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Label(ec, text='Please enter your subject name!!!', fg='white', bg='white', font=('times', 16, ' bold ')).pack()
        Button(ec, text='OK', command=ec_delete, fg="white", bg="white", width=9, height=1, activebackground="Red",
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            ENR = tk.Label(MFW, text="Enter Enrollment", width=15, height=2, fg="pink", bg="blue2",
                           font=('times', 15, ' bold '))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Student name", width=15, height=2, fg="pink", bg="white",
                                font=('times', 15, ' bold '))
            STU_NAME.place(x=30, y=200)

            global ENR_ENTRY
            ENR_ENTRY = tk.Entry(MFW, width=20,validate='key', bg="pink", fg="white", font=('times', 23, ' bold '))
            ...
            def create_csv():
                ...
                csv_name='D:/studies/7th sem/project/projects/Attendace_management_system-master/Attendace_management_system-master/Attendance'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"D:\studies\7th sem\project\projects\Attendace_management_system-master\Attendace_management_system-master\Attendance\Manually Attendance-------Check atttendance-------"')
    ...
    fill_manual_attendance = tk.Button(sb, text="Fill Attendance",command=fill_attendance, fg="white", bg="white", width=20, height=2,
                       activebackground="Red", font=('times', 15, ' bold '))
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            with open('D:/studies/7th sem/project/Attendace_management_system-master/Attendace_management_system-master/StudentDetails/StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    ...
                    Notifica.configure(text=e, bg="white", fg="black", width=33, font=('times', 15, 'bold'))
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='localhost', user='root', password='', db='facerecog')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='snow')
                cs = 'D:/studies/7th sem/project/projects/Attendace_management_system-master' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"D:\studies\7th sem\project\projects\Attendace_management_system-master\Attendace_management_system-master\Attendance-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'eeda' :
            if password == 'eeda123':
                ...
                cs = 'D:\studies\7th sem\project\Attendace_management_system-master\Attendace_management_system-master\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    try:
        ...
        Notification.configure(text=q, bg="Snow", width=50, font=('times', 18, 'bold'))
        Notification.place(x=350, y=400)
