...
def take_img():
    try:
        ...
        Enrollment = txt.get()
        Name = txt2.get()
        path = 'D:\studies\7th sem\project\Attendace_management_system-master\Attendace_management_system-master\Datasets' + Enrollment + ' ' + Name
        new_path = 'D:\studies\7th sem\project\Attendace_management_system-master\Attendace_management_system-master\Datasets' + Enrollment + ' ' + Name + '/'
        os.mkdir(path)
        sampleNum = 0
